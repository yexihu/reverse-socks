 ...
 */
public class SocksDialog extends JFrame implements WindowListener, ItemListener, ActionListener, Runnable {
	 ...
	 * f.pack(); f.show(); f.addWindowListener(socksdialog); CProxy p =
